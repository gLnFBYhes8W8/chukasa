package pro.hirooka.chukasa.chukasa_api.app.api.v1.helper;
...
public class DirectoryCreator implements IDirectoryCreator{
    ...
    final String STREAM_ROOT_PATH_NAME = ChukasaConstants.STREAM_ROOT_PATH_NAME;
    final String LIVE_PATH_NAME = ChukasaConstants.LIVE_PATH_NAME;
