...
//
//    private static final Logger log = LoggerFactory.getLogger(ProgramTableService.class);
//
//    @Autowired
...
//        return programRepository.findAllByChannelRecording(physicalLogicalChannel);
//    }
//
//    @Override
